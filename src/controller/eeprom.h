...
// for oem display
#define ADDRESS_MOTOR_ASSISTANCE_WITHOUT_PEDAL_ROTATION EEPROM_BASE_ADDRESS + 9 // not used
#define ADDRESS_ENABLE_ODOMETER_COMPENSATION			EEPROM_BASE_ADDRESS + 10
...
#define ADDRESS_TORQUE_SENSOR_CALIBRATED				EEPROM_BASE_ADDRESS + 18 // not used
